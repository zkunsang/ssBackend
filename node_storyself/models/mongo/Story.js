...
const Schema = {
  ...
  STATUS: {
    ...
    validRange: Object.values(StoryStatus),
  },
  ...
  RECORD_COUNT: { key: "recordCount", required: false, type: ValidType.NUMBER },
};
...
class Story extends Model {
  constructor({
    ...
    this[Schema.THUMBNAIL_CRC32.key] =
      ValidateUtil.setNullUndefined(thumbnailCrc32);
    this[Schema.THUMBNAIL_VERSION.key] =
      ValidateUtil.setNullUndefined(thumbnailVersion);

    this[Schema.TEXTFILE.key] = ValidateUtil.setNullUndefined(textFile);
    this[Schema.TEXTFILE_CRC32.key] =
      ValidateUtil.setNullUndefined(textFileCrc32);
    this[Schema.TEXTFILE_VERSION.key] =
      ValidateUtil.setNullUndefined(textFileVersion);
    ...
    this[Schema.RECORD_COUNT.key] = ValidateUtil.setNullUndefined(recordCount);
  }
