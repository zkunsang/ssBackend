...
class ResContext {
  constructor(ctx) {
    ...
    this.ctx.body.common.aosAppVersion = aosVersion
      ? aosVersion.value
      : undefined;
    this.ctx.body.common.iosAppVersion = iosVersion
      ? iosVersion.value
      : undefined;
    this.ctx.body.common.couponEnable = couponEnable
      ? JSON.parse(couponEnable.value)
      : undefined;

    this.ctx.body.common.serverTime = ctx.$date;
  }

  setMs(startDate, endDate) {
    this.ctx.body.common.ms = endDate - startDate;
  }
  ...
  setSessionCookie(value) {
    this.setCookie("sessionId", value, {
